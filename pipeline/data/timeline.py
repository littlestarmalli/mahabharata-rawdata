"""Hardcoded timeline events for the Mahabharata knowledge graph.
Year 0 = Kurukshetra War, negative = before, positive = after."""


def get_timeline():
    """Return dict of all 58 timeline events keyed by evt_001..evt_058."""
    return {
        # ─── Pre-War Era ───
        "evt_001": {
        ...
        "evt_002": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@bhishma", "@shantanu", "@satyavati"],
        ...
        "evt_003": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@vyasa", "@ambika", "@ambalika", "@satyavati"],
        ...
        "evt_004": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@pandu", "@dhritarashtra", "@bhishma"],
        ...
        "evt_006": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@kunti", "@surya", "@karna"],
        ...
        "evt_007": {
            ...
            "Location": "@shatashriga",
            "Participants": ["@kunti", "@yama", "@yudhishthira"],
        ...
        "evt_009": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@gandhari", "@vyasa", "@duryodhana", "@duhshala"],
        ...
        "evt_010": {
            ...
            "Location": "@shatashriga",
            "Participants": ["@kunti", "@indra", "@arjuna"],
        ...
        "evt_011": {
            ...
            "Location": "@shatashriga",
            "Participants": ["@madri", "@ashvins", "@nakula", "@sahadeva"],
        ...
        "evt_013": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@drona", "@arjuna", "@bhima", "@yudhishthira", "@duryodhana", "@karna", "@ashvatthama"],
        ...
        "evt_015": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@karna", "@arjuna", "@duryodhana", "@drona"],
        ...
        "evt_016": {
            ...
            "Participants": ["@duryodhana", "@yudhishthira", "@vidura", "@bhima"],
        ...
        "evt_018": {
            ...
            "Location": "@panchala",
            "Participants": ["@arjuna", "@draupadi", "@drupada", "@kunti", "@yudhishthira", "@bhima", "@nakula", "@sahadeva", "@karna"],
        ...
        "evt_019": {
            ...
            "Participants": ["@yudhishthira", "@arjuna", "@krishna"],
        ...
        "evt_020": {
            ...
            "Location": "@khandava_forest",
            "Participants": ["@arjuna", "@krishna", "@agni", "@indra"],
        ...
        "evt_021": {
            ...
            "Location": "@indraprastha",
            "Participants": ["@yudhishthira", "@krishna", "@shishupala", "@bhima", "@arjuna"],
        ...
        "evt_022": {
            ...
            "Location": "@girivraja",
            "Participants": ["@bhima", "@krishna", "@arjuna", "@jarasandha"],
        ...
        "evt_023": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@yudhishthira", "@shakuni", "@duryodhana", "@duhshasana", "@draupadi", "@dhritarashtra", "@vidura", "@bhishma", "@karna"],
        ...
        "evt_024": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@yudhishthira", "@shakuni"],
        ...
        "evt_025": {
            ...
            "Location": "@kamyaka_forest",
            "Participants": ["@yudhishthira", "@bhima", "@arjuna", "@nakula", "@sahadeva", "@draupadi"],
        ...
        "evt_028": {
            ...
            "Location": "@kamyaka_forest",
            "Participants": ["@jayadratha", "@draupadi", "@bhima", "@arjuna", "@yudhishthira"],
        ...
        "evt_029": {
            ...
            "Location": "@gandhamadana",
            "Participants": ["@bhima", "@hanuman"],
        ...
        "evt_030": {
            ...
            "Location": "@kamyaka_forest",
            "Participants": ["@yudhishthira", "@nala", "@damayanti"],
        ...
        "evt_031": {
            ...
            "Location": "@dvaitavana",
            "Participants": ["@duryodhana", "@chitrasena_gandharva", "@arjuna", "@yudhishthira"],
        ...
        "evt_032": {
            ...
            "Location": "@viratanagara",
            "Participants": ["@yudhishthira", "@bhima", "@arjuna", "@nakula", "@sahadeva", "@draupadi", "@virata"],
        ...
        "evt_034": {
            ...
            "Location": "@viratanagara",
            "Participants": ["@arjuna", "@duryodhana", "@bhishma", "@drona", "@karna"],
        ...
        "evt_035": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@krishna", "@duryodhana", "@dhritarashtra", "@gandhari", "@vidura", "@karna", "@bhishma"],
        ...
        "evt_038": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@bhishma", "@dhrishtadyumna", "@arjuna", "@duryodhana"],
        ...
        "evt_039": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@bhishma", "@arjuna", "@shikhandi", "@duryodhana"],
        ...
        "evt_040": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@abhimanyu", "@jayadratha", "@drona", "@karna", "@duhshasana", "@duryodhana"],
        ...
        "evt_041": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@arjuna", "@krishna", "@jayadratha"],
        ...
        "evt_042": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@ghatotkacha", "@karna"],
        ...
        "evt_043": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@drona", "@dhrishtadyumna", "@yudhishthira", "@ashvatthama"],
        ...
        "evt_044": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@karna", "@duryodhana", "@arjuna", "@shalya"],
        ...
        "evt_045": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@karna", "@arjuna", "@krishna", "@bhima", "@duhshasana", "@shalya"],
        ...
        "evt_046": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@duryodhana", "@bhima", "@shalya", "@yudhishthira", "@shakuni", "@sahadeva", "@balarama", "@krishna"],
        ...
        "evt_047": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@ashvatthama", "@kripa", "@kritavarma", "@dhrishtadyumna"],
        ...
        "evt_048": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@ashvatthama", "@arjuna", "@krishna", "@vyasa"],
        ...
        "evt_049": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@gandhari", "@krishna", "@dhritarashtra", "@kunti", "@draupadi"],
        ...
        "evt_050": {
            ...
            "Location": "@kurukshetra",
            "Participants": ["@bhishma", "@yudhishthira", "@krishna"],
        ...
        "evt_052": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@yudhishthira", "@krishna", "@bhima", "@arjuna", "@vidura", "@dhritarashtra"],
        ...
        "evt_053": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@yudhishthira", "@arjuna", "@babhruvahana"],
        ...
        "evt_054": {
            ...
            "Location": "@hastinapura",
            "Participants": ["@dhritarashtra", "@gandhari", "@kunti", "@vidura", "@sanjaya"],
        ...
        "evt_056": {
            ...
            "Location": "@dvaraka",
            "Participants": ["@krishna", "@balarama", "@pradyumna", "@samba"],
        ...
        "evt_058": {
            ...
            "Location": "@svarga",
            "Participants": ["@yudhishthira", "@indra", "@yama"],
